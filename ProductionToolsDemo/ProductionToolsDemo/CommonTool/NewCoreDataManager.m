...
#import "NewCoreDataManager.h"

@interface NewCoreDataManager ()
...
@implementation NewCoreDataManager

+ (NewCoreDataManager *)shareInstance
{
    static NewCoreDataManager *manager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        manager = [[NewCoreDataManager alloc] init];
    });
    return manager;
}
...
- (NSManagedObjectContext *)managedObjectContext
{
    ...
    if(systemNum < 10.0)
    {
        return KNewCoreDataManager.managedObjectContext1;
    }
    else
    {
        return KNewCoreDataManager.persistentContainer.viewContext;
    }
}
...
- (NSPersistentContainer *)getCurrentPersistentContainer
{
    ...
    {
        return KNewCoreDataManager.persistentContainer;
    }
}
...
{
    NSError *error = nil;
    [KNewCoreDataManager.managedObjectContext save:&error];
